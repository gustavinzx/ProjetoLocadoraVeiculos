...
/**
 * Testes de integração da classe UsuarioService.
 * CT-026 a CT-033
 */
...
class UsuarioServiceTest {
    ...
    static void inicializar() throws Exception {
        String url = "jdbc:sqlite:file:testUsuario?mode=memory&cache=shared";
        Database.setUrl(url);
    ...
    void testLoginUsernameInexistente() {
        assertNull(service.autenticar("usuario_fantasma", "qualquersenha"));
    }

    @Test
    @DisplayName("CT-029 | Login com credenciais nulas retorna null")
    void testLoginCredenciaisNulas() {
        assertNull(service.autenticar(null, null));
    }
